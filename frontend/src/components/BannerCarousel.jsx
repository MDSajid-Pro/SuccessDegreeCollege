...
const BannerCarousel = () => {
  ...
  const banner1Data = {
    ...
    achievers: [
      { name: "Zeba Tarannum", Do: "U04FK21S0021", per: "86.5%" },
      { name: "Asma Anjum", Do: "U04FK21S0014", per: "86%" },
      { name: "Javeriya Siddiqua", Do: "U04FK21S0018", per: "84.9%" },
      { name: "Shifa Faraaz", Do: "U04FK21S0015", per: "84%" },
      { name: "Syeda Arbiya", Do: "U04FK21S0019", per: "82.8%" },
      { name: "Adeeba Fatima", Do: "U04FK21S0044", per: "82.5%" },
      { name: "Syed Adnan Musa", Do: "U04FK21S0035", per: "82.2%" },
      { name: "Merajunnisa", Do: "U04FK21S0013", per: "82%" },
    ],
    stats: [
      { label: "B.Sc", count: "27" },
  ...
  const banner2Data = {
    ...
    achievers: [
      { name: "Saniya Tabassum", Do: "U04FK22S0005", per: "89.1%" },
      { name: "Shireen Sana", Do: "U04FK22S0017", per: "88.9%" },
      { name: "Humaira", Do: "U04FK22S0022", per: "88.9%" },
      { name: "Shireen Sana", Do: "U04FK22S0017", per: "88.9%" },
      { name: "Arshiya Begum", Do: "U04FK22S0004", per: "88.1%" },
      { name: "Husna", Do: "U04FK22S0010", per: "88.1%" },
      { name: "Arbiya Kashaf", Do: "U04FK22S0006", per: "87.2%" },
      { name: "Tahniyat", Do: "U04FK22S0013", per: "86.5%" },
    ],
    stats: [
      { label: "B.Sc", count: "19" },
      { label: "B.Com", count: "08" },
