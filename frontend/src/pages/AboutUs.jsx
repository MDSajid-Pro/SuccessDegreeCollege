...
const AboutUs = () => {
  return (
    <section id="about" className="bg-white py-12 px-4 md:px-8 lg:px-16 pt-24">
      {/* About Us */}
      ...
      {/* Mission */}
      <h3 className="text-3xl font-bold text-red-700 mt-8 mb-2">Mission</h3>
