...
const courseData = {
  bsc: {
    ...
    description: "A 3-year undergraduate program that builds a strong foundation in Physics, Chemistry, Mathematics, Botany, and Zoology. Designed for students with a passion for research and innovation.",
    duration: "3 Years",
    ...
    syllabus: [
      ...
      { title: "Lab Work", desc: "Practical experiments & Record maintenance" },
    ],
    careers: ["Research Scientist", "Lecturer", "Lab Technician", "Biotechnologist", "Civil Services"],
  },
  bca: {
